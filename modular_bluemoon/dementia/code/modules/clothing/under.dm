/obj/item/clothing/under/utility/green
	...
	item_state = "utilgreen"
	icon = 'modular_bluemoon/dementia/icons/obj/clothing/under.dmi'
	mob_overlay_icon = 'modular_bluemoon/dementia/icons/mob/clothing/under.dmi'
	anthro_mob_worn_overlay = 'modular_bluemoon/dementia/icons/mob/clothing/under_digi.dmi'

/obj/item/clothing/under/utility/navy
