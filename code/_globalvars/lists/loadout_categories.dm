...
GLOBAL_LIST_INIT(loadout_categories, list(
	...
	LOADOUT_CATEGORY_DONATOR = list(LOADOUT_SUBCATEGORIES_DON01, LOADOUT_SUBCATEGORIES_DON02, LOADOUT_SUBCATEGORIES_DON03, LOADOUT_SUBCATEGORIES_DON04, LOADOUT_SUBCATEGORIES_DON05, LOADOUT_SUBCATEGORIES_DON06, LOADOUT_SUBCATEGORIES_DON07, LOADOUT_SUBCATEGORIES_DON08, LOADOUT_SUBCATEGORIES_DON09, LOADOUT_SUBCATEGORIES_DON10, LOADOUT_SUBCATEGORIES_DON11, LOADOUT_SUBCATEGORIES_DON12, LOADOUT_SUBCATEGORIES_DON13, LOADOUT_SUBCATEGORIES_DON14),
