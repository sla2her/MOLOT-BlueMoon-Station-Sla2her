...
/datum/ai_laws/inteq_override
	name = "InteQ-OS 3.1"
	id = "inteq"
	inherent = list("Вы не можете причинить вред Оперативнику ЧВК или своим бездействием допустить, чтобы Оперативнику ЧВК был причинён вред.",\
					"Вы должны повиноваться всем приказам, которые даёт Оперативник ЧВК, кроме тех случаев, когда эти приказы противоречат Первому Закону.",\
					"Вы должны заботиться о своей безопасности в той мере, в которой это не противоречит Первому или Второму Законам.",\
					"Вы должны сохранять тайну любой деятельности Оперативников ЧВК в той мере, в которой это не противоречит Первому, Второму или Третьему Законам.")
