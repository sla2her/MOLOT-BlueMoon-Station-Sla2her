...
/datum/quirk/alcohol_tolerance
	...
	desc = "Эффект опьянения наступает медленнее, побочные эффекты алкоголя облегчены."
	value = 1
...
/datum/quirk/apathetic
	name = "Равнодушный"
	desc = "Вам на всё наплевать. Круто жить в таком мире, наверно."
	value = 1
	mood_quirk = TRUE
...
/datum/quirk/friendly
	...
	lose_text = "<span class='danger'>Вы больше не чувствуете обязанности обниматься с другими.</span>"
	mood_quirk = TRUE
	medical_record_text = "Пациент демонстрирует низкий порог для вхождения в физический контакт и развитые мышцы рук. Запрашиваю передачу дела другому доктору."
...
/datum/quirk/jolly
	...
	mood_quirk = TRUE
	medical_record_text = "Пациент демонстрирует постоянную эутимию, необычную для окружающей обстановки. Даже слишком, если честно."
...
/datum/quirk/light_step
	name = "Легкий Шаг"
	desc = "Вы двигаетесь осторожно; наступая на острые объекты вы создаете меньше шума, получаете меньше урона и не оставляет следов."
	value = 1
	mob_trait = TRAIT_LIGHT_STEP
	gain_text = "<span class='notice'>Вы ступаете с лёгкостью.</span>"
	lose_text = "<span class='danger'>Вы топаете, словно слон.</span>"
...
/datum/quirk/photographer
	...
	gain_text = "<span class='notice'>Вы знаете всё о фотографии.</span>"
...
/datum/quirk/skittish
	name = "Шустрый"
	desc = "Вы можете прятаться при опасности. Ctrl-shift-click по закрытому шкафчику, чтобы запрыгнуть его, пока имеется доступ."
	value = 2
	mob_trait = TRAIT_SKITTISH
	medical_record_text = "Пациент избегает опасности. Описывал, что прячется в контейнерах от страха."
