/datum/element/photosynthesis_revert
...
/datum/element/photosynthesis_revert/Attach(datum/target, brute = 1, burn = 1, tox = 1, oxy = 1, nutri = -4, minus = -0.2, bonus = -0.3, malus = 0.1)
	. = ..()
...
/datum/element/photosynthesis_revert/Detach(datum/target)
	attached_atoms[target]--
...
/datum/element/photosynthesis_revert/process()
