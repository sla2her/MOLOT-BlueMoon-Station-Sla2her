/datum/round_event_control/deathclaw_basic_man
	name = "Sexy Deathclaws in Techmain: Basic Male"
	typepath = /datum/round_event/deathclaw_basic_man
	max_occurrences = 5
	weight = 60
	category = EVENT_CATEGORY_ENTITIES

/datum/round_event/deathclaw_basic_man/announce(fake)
...
/datum/round_event/deathclaw_basic_man/start()
	...
	var/mob/living/simple_animal/hostile/deathclaw/funclaw/gentle/newclaw/S = new(T)
