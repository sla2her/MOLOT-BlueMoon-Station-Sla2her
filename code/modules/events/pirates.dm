...
/proc/pirates_answered(datum/comm_message/threat_msg, payoff, ship_name, initial_send_time, response_max_time, ship_template)
	if(world.time > initial_send_time + response_max_time)
		priority_announce("Too late to beg for mercy!", 'modular_bluemoon/phenyamomota/sound/announcer/pirate_nopeacedecision.ogg', sender_override = ship_name, has_important_message = TRUE)
		return
