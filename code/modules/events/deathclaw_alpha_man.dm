/datum/round_event_control/deathclaw_alpha_man
	name = "Sexy Deathclaws in Techmain: Alpha Male"
	typepath = /datum/round_event/deathclaw_alpha_man
	max_occurrences = 5
	weight = 60
	category = EVENT_CATEGORY_ENTITIES

/datum/round_event/deathclaw_alpha_man/announce(fake)
...
/datum/round_event/deathclaw_alpha_man/start()
	...
	var/mob/living/simple_animal/hostile/deathclaw/funclaw/gentle/newclaw/alphaclaw/S = new(T)
