...
/mob/living/simple_animal/revenant/Initialize(mapload)
	...
	AddSpell(new /obj/effect/proc_holder/spell/aoe/revenant/defile(null))
	AddSpell(new /obj/effect/proc_holder/spell/aoe/revenant/overload(null))
	AddSpell(new /obj/effect/proc_holder/spell/aoe/revenant/blight(null))
	AddSpell(new /obj/effect/proc_holder/spell/aoe/revenant/malfunction(null))
