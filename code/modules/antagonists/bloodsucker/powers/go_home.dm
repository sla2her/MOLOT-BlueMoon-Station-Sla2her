...
/datum/action/bloodsucker/gohome/ActivatePower()
	...
	var/mob/living/simple_animal/SA = pick(/mob/living/simple_animal/mouse,/mob/living/simple_animal/mouse,/mob/living/simple_animal/mouse, /mob/living/simple_animal/hostile/bat) //prob(300) /mob/living/simple_animal/mouse,
	new SA (owner.loc)
