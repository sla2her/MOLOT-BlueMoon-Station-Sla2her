...
/obj/item/paper/pamphlet/ruin/originalcontent/stickman
	name = "Painting - 'BANG'"
	default_raw_text = "_This picture depicts a crudely-drawn stickman firing a crudely-drawn gun._"
	icon_state = "painting4"

/obj/item/paper/pamphlet/ruin/originalcontent/treeside
	name = "Painting - 'Treeside'"
	default_raw_text = "_This picture depicts a sunny day on a lush hillside, set under a shaded tree._"
	icon_state = "painting1"

/obj/item/paper/pamphlet/ruin/originalcontent/pennywise
	name = "Painting - 'Pennywise'"
	default_raw_text = "_This picture depicts a smiling clown. Something doesn't feel right about this.._"
	icon_state = "painting3"

/obj/item/paper/pamphlet/ruin/originalcontent/yelling
	name = "Painting - 'Hands-On-Face'"
	default_raw_text = "_This picture depicts a man yelling on a bridge for no apparent reason._"
