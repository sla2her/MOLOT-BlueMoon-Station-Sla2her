...
/obj/item/hilbertshotel
	...
	//BlueMoon Edit
	var/list/static/hotel_maps = list("Generic (Don't Use)", "Apartment", "Apartment_1", "Apartment_2", "Apartment_3", "Apartment_bar", "Apartment_syndi", "Apartment_dojo", "Apartment_sauna", "Apartment_beach")
	...
	var/datum/map_template/ghost_cafe_rooms/beach/ghost_cafe_rooms_apartment_beach
	//BlueMoon Edit
...
/obj/item/hilbertshotel/proc/prepare_rooms()
	...
	ghost_cafe_rooms_apartment_beach = new()
	//BlueMoon Edit
...
/obj/item/hilbertshotel/proc/sendToNewRoom(roomNumber, mob/user, chosen_room) //BLUEMOON EDIT ADDITION - GHOST HOTEL UPDATE. Was sendToNewRoom(chosenRoomNumber, target)
	...
	if(ruinSpawned && roomNumber == mysteryRoom)
		...
		switch(chosen_room)
			...
			if("Apartment_beach")
				ghost_cafe_rooms_apartment_beach.load(locate(roomReservation.bottom_left_coords[1], roomReservation.bottom_left_coords[2], roomReservation.bottom_left_coords[3]))
			else
