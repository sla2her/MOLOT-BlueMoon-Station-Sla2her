...
/datum/customer_data/american
	...
	orderable_objects = list(
		VENUE_RESTAURANT = list(
			/obj/item/reagent_containers/food/snacks/burger/plain = 25,
			/obj/item/reagent_containers/food/snacks/burger/cheese = 15,
			/obj/item/reagent_containers/food/snacks/burger/superbite = 1,
			/obj/item/reagent_containers/food/snacks/fries = 10,
			/obj/item/reagent_containers/food/snacks/cheesyfries = 6,
			/obj/item/reagent_containers/food/snacks/pie/applepie = 4,
			/obj/item/reagent_containers/food/snacks/pie/pumpkinpie = 2,
			...
			/obj/item/reagent_containers/food/snacks/pancakes = 4
		),
		VENUE_BAR = list(
...
/datum/customer_data/italian
	...
	orderable_objects = list(
		VENUE_RESTAURANT = list(
			...
			/obj/item/reagent_containers/food/snacks/copypasta = 6,
			/obj/item/reagent_containers/food/snacks/meatballspaghetti = 4,
			/obj/item/reagent_containers/food/snacks/butternoodles = 4,
			/obj/item/reagent_containers/food/snacks/pizza/vegetable = 2,
			/obj/item/reagent_containers/food/snacks/pizza/mushroom = 2,
			/obj/item/reagent_containers/food/snacks/pizza/meat = 2,
			/obj/item/reagent_containers/food/snacks/pizza/margherita = 2,
			/obj/item/reagent_containers/food/snacks/eggplantparm = 3,
		),
		VENUE_BAR = list(
...
/datum/customer_data/french
	...
	orderable_objects = list(
		VENUE_RESTAURANT = list(
			/obj/item/reagent_containers/food/snacks/baguette = 20,
			/obj/item/reagent_containers/food/snacks/garlicbread = 5,
			/obj/item/reagent_containers/food/snacks/soup/onion = 4,
			/obj/item/reagent_containers/food/snacks/pie/berryclafoutis = 2,
...
/datum/customer_data/japanese
	...
	orderable_objects = list(
		VENUE_RESTAURANT = list(
			/obj/item/reagent_containers/food/snacks/tofu = 5,
			/obj/item/reagent_containers/food/snacks/breadslice/plain = 5,
			/obj/item/reagent_containers/food/snacks/soup/vegetable = 4,
			/obj/item/reagent_containers/food/snacks/sashimi = 4,
			/obj/item/reagent_containers/food/snacks/chawanmushi = 4,
			/obj/item/reagent_containers/food/snacks/muffin/berry = 2,
		),
		VENUE_BAR = list(
...
/datum/customer_data/japanese/salaryman
	...
	orderable_objects = list(
		VENUE_RESTAURANT = list(
			...
			/obj/item/reagent_containers/food/snacks/sashimi = 4,
			/obj/item/reagent_containers/food/snacks/chawanmushi = 4,
			/obj/item/reagent_containers/food/snacks/meatbun = 4,
		),
		VENUE_BAR = list(
...
/datum/customer_data/moth/proc/get_wings(mob/living/simple_animal/robot_customer/customer)
	...
	if (!LAZYACCESS(wings_chosen, customer_ref))
		LAZYSET(wings_chosen, customer_ref, GLOB.insect_wings_list[pick(GLOB.insect_wings_list)])
...
/datum/customer_data/moth/get_underlays(mob/living/simple_animal/robot_customer/customer)
	...
	var/datum/sprite_accessory/insect_wings/wings = get_wings(customer)

	var/mutable_appearance/wings_behind = mutable_appearance(icon = 'icons/mob/wings.dmi', icon_state = "[wings.icon_state]")
...
/datum/customer_data/moth/get_overlays(mob/living/simple_animal/robot_customer/customer)
	...
	var/mutable_appearance/wings_front = mutable_appearance(icon = 'icons/mob/wings.dmi', icon_state = "[wings.icon_state]")
...
/datum/customer_data/mexican
	...
	orderable_objects = list(
		VENUE_RESTAURANT = list(
			/obj/item/reagent_containers/food/snacks/taco/plain = 25,
			/obj/item/reagent_containers/food/snacks/taco = 15,
			/obj/item/reagent_containers/food/snacks/burrito = 15,
			/obj/item/reagent_containers/food/snacks/fuegoburrito = 1,
			/obj/item/reagent_containers/food/snacks/cheesyburrito = 4,
			/obj/item/reagent_containers/food/snacks/nachos = 10,
			/obj/item/reagent_containers/food/snacks/cheesynachos = 6,
			/obj/item/reagent_containers/food/snacks/pie/dulcedebatata = 2,
			/obj/item/reagent_containers/food/snacks/cubannachos = 3,
			/obj/item/reagent_containers/food/snacks/stuffedlegion = 1,
		),
		VENUE_BAR = list(
...
/datum/customer_data/british
	...
	orderable_objects = list(
		VENUE_RESTAURANT = list(
			...
			/obj/item/reagent_containers/food/snacks/soup/stew = 10,
			/obj/item/reagent_containers/food/snacks/salad/ricepudding = 5,
			/obj/item/reagent_containers/food/snacks/sandwich = 5,
			/obj/item/reagent_containers/food/snacks/pie/meatpie = 5,
			/obj/item/reagent_containers/food/snacks/benedict = 5,
		),
		VENUE_BAR = list(
...
/datum/customer_data/malfunction
	...
	orderable_objects = list(
		VENUE_RESTAURANT = list(
			...
			/obj/item/reagent_containers/food/snacks/cannedpeaches/maint = 6,
		),
		VENUE_BAR = list(
			/datum/reagent/spraytan = 1,
			/datum/reagent/fermi/basic_buffer = 1,
			/datum/reagent/fermi/acidic_buffer = 1,
		),
	)
