/obj/machinery/vending/coffee
	...
	product_slogans = "Выпейте!;Выпейте!;Это полезно для вас!;Хотите горячего кофе?;Я бы убил за кофе!;Лучшие зерна в галактике.;Только лучшее варево для вас.;Мммм... ничто не сравнится с кофе.;Я люблю кофе, а вы?;Кофе помогает работать!;Попробуйте чай.;Мы надеемся, что вам понравится!;Попробуйте наш новый шоколад!;Заговоры администраторов..."
	icon_state = "coffee"
