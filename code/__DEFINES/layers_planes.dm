...
#define EMISSIVE_UNBLOCKABLE_PLANE 2.5 //Пробуем починить Леерсы.
#define EMISSIVE_UNBLOCKABLE_LAYER 2.5
#define EMISSIVE_LAYER_UNBLOCKABLE 2.5
#define EMISSIVE_UNBLOCKABLE_RENDER_TARGET "*EMISSIVE_UNBLOCKABLE_PLANE"
#define EMISSIVE_RENDER_TARGET "*EMISSIVE_PLANE"

#define LIGHTING_PLANE 2.55
#define LIGHTING_LAYER 2.55
...
#define ABOVE_LIGHTING_PLANE 2.6
#define ABOVE_LIGHTING_LAYER 2.6 //Пробуем починить Леерсы.
