...
#define EMISSIVE_UNBLOCKABLE_PLANE 3 //Пробуем починить Леерсы.
#define EMISSIVE_UNBLOCKABLE_LAYER 3
#define EMISSIVE_LAYER_UNBLOCKABLE 3
...
#define ABOVE_LIGHTING_LAYER 3 //Пробуем починить Леерсы.
