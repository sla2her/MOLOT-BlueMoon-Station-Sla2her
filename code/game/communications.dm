...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_PIRATE]" = RADIO_CHANNEL_PIRATE, //SKYRAT EDIT ADDITION - MAPPING
	"[FREQ_DS1]" = RADIO_CHANNEL_DS1, //SKYRAT EDIT ADDITION - MAPPING
	"[FREQ_DS2]" = RADIO_CHANNEL_DS2, //SKYRAT EDIT ADDITION - MAPPING
	"[FREQ_TARKOFF]" = RADIO_CHANNEL_TARKOFF, //SKYRAT EDIT ADDITION - MAPPING
