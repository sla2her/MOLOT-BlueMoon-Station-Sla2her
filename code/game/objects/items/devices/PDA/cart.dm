...
//Neither copytext nor copytext is appropriate here; neither 30 UTF-8 code units nor 30 code points equates to 30 columns of output.
...
//would be to use <span style="width: NNNpx; overflow: none;">[A.area.name]</span>
					for(var/obj/machinery/power/apc/A in L)
						menu += copytext(add_trailing(A.area.name, 30, " "), 1, 30)
