...
/obj/item/electropack/suicide_act(mob/living/carbon/user)
	user.visible_message("<span class='suicide'>[user] hooks себя to the electropack and spams the trigger! It looks like [user.ru_who()] trying to commit suicide!</span>")
	return (FIRELOSS)
