...
GLOBAL_LIST_INIT(metal_recipes, list ( \
	...
	new/datum/stack_recipe_list("sofas", list( \
		...
		new /datum/stack_recipe("sofa (corner)", /obj/structure/chair/sofa/corner/brown, one_per_turf = TRUE, on_floor = TRUE), \
		)), \
	//END OF CIT CHANGES
...
GLOBAL_LIST_INIT(wood_recipes, list ( \
	...
	new/datum/stack_recipe("Гипер-Микро-Сауна", /obj/structure/sauna_oven, 50, time = 15 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
