...
/obj/item/stack/rods/suicide_act(mob/living/carbon/user)
	user.visible_message("<span class='suicide'>[user] begins to stuff \the [src] down [user.ru_ego()] throat! It looks like [user.ru_who()] trying to commit suicide!</span>")//it looks like theyre ur mum
	return BRUTELOSS
