/datum/game_mode/gang
	...
	restricted_jobs = list("Cyborg", "AI", "Prisoner","Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Blueshield", "Brig Physician", "Peacekeeper", "NanoTrasen Representative", "Lawyer")//N O
	protected_jobs = list()
