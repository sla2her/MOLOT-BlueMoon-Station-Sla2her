...
/mob/living/simple_animal/qareen/Initialize(mapload)
	...
	AddSpell(new /obj/effect/proc_holder/spell/aoe/qareen/defile(null))
	AddSpell(new /obj/effect/proc_holder/spell/aoe/qareen/overload(null))
	AddSpell(new /obj/effect/proc_holder/spell/aoe/qareen/bliss(null))
	AddSpell(new /obj/effect/proc_holder/spell/aoe/qareen/malfunction(null))
	random_qareen_name()
