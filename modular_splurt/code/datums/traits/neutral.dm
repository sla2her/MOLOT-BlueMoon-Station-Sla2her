...
/datum/quirk/storage_concealment
	...
	desc = "У вас вызывает отвращение сама идея быть увиденным с любым контейнером, закрепленным на спине! Новая технология скрывает вашу спину, таким образом защищая вас от безмерного стыда."
