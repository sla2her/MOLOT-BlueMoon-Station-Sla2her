...
/datum/quirk/storage_concealment
	...
	desc = "У вас вызывает отвращение сама идея быть увиденным с любым контейнером, закрепленным на спине! Новая технология скрывает спину, таким образом защищая от безмерного стыда."
